...
exports.runAssetVulnerabilityScan = runAssetVulnerabilityScan;
exports.addMonitoredAsset = addMonitoredAsset;
...
async function runAssetVulnerabilityScan(assetId) {
...
async function addMonitoredAsset(newAsset) {
    const asset = {
