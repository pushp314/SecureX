...
exports.recordNetworkFlow = recordNetworkFlow;
exports.getNetworkFlows = getNetworkFlows;
exports.getNetworkAnomalies = getNetworkAnomalies;
exports.getNetworkStats = getNetworkStats;
exports.getGeoRadarOrigins = getGeoRadarOrigins;
const client_1 = require("../../db/client");
// In-Memory Flow Cache
const NETWORK_FLOWS = [];
const NETWORK_ANOMALIES = [];
// Seed initial baseline traffic
function seedInitialFlows() {
    const protocols = ['HTTPS', 'TCP', 'DNS', 'HTTPS', 'TCP'];
...
seedInitialFlows();
function recordNetworkFlow(flow) {
    const completeFlow = {
...
function getNetworkFlows(limit = 100) {
    return NETWORK_FLOWS.slice(0, limit);
}
function getNetworkAnomalies() {
...
async function getGeoRadarOrigins() {
