...
exports.sigmaCompiler = exports.SigmaCompilerEngine = void 0;
...
class SigmaCompilerEngine {
    ...
    async deployRule(ruleId) {
        const rule = SIGMA_RULES.find((r) => r.id === ruleId);
        if (!rule)
            throw new Error(`Sigma rule not found: ${ruleId}`);
        ...
        await client_1.prisma.detectionRule.upsert({
...
exports.SigmaCompilerEngine = SigmaCompilerEngine;
exports.sigmaCompiler = new SigmaCompilerEngine();
