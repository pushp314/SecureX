...
async function seed() {
    ...
    await client_1.prisma.apiKey.upsert({
        where: { key: env_1.config.defaultApiKey },
        update: {},
        create: {
            key: env_1.config.defaultApiKey,
            name: 'Default Production Ingestion Key',
            tenantId: 'tenant-enterprise-01',
            isActive: true,
        },
    });
    console.log(`[Seed] Ingestion API Key active: ${env_1.config.defaultApiKey}`);
